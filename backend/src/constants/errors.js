...
export const EMPTY_FIELD_MESSAGE = (field) => `Pole nie może być puste ${field}!`
...
export const CONCURRENCY_LIMIT_MESSAGE = () => 'Za dużo równoległych requestów w aplikacji. Spróbuj za chwilę.'
